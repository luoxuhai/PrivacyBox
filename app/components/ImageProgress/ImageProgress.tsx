...
export interface ImageProgressWrapperProps extends ImageProps {
  renderIndicator: (progress: number, indeterminate: boolean) => React.ReactNode;
  renderError: (error: any) => React.ReactNode;
  threshold?: number;
  component?: React.FunctionComponent | React.Component;
}

export const createImageProgress = (ImageComponent: any) => (props: ImageProgressWrapperProps) => {
